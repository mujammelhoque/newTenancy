...
<body>
	...
	<div class="main-wrapper">
		...
		<div class="header">
			...
			<div class="header-left">
				<a href="{{ route('tenant.admin.dashboard') }}" class="logo">
			...
			<ul class="nav user-menu">
				...
				<li class="nav-item dropdown has-arrow main-drop">
					<a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
						<span class="user-img">
						<img src="{{ URL::to('/assets/images/' )}}" alt="{{ Auth::user()->name??'' }}">
						<span class="status online"></span></span>
						<span>{{ Session::get('name') }}</span>
					</a>
					<div class="dropdown-menu">
						<a class="dropdown-item" href="{{ url('profile_user') }}">My Profile</a>
						<a class="dropdown-item" href="{{ url('company/settings/page') }}">Settings</a>
		...
		<!-- /Header -->
		<!-- Sidebar -->
		@include('tenant.admin.payslip.sidebar.sidebar')
		<!-- /Sidebar -->
		<!-- Page Wrapper -->
		@yield('content')
		<!-- /Page Wrapper -->
	...
	<!-- jQuery -->
	<script src="{{ URL::to('tenancy/assets/admin/assets/js/jquery-3.5.1.min.js') }}"></script>
	<!-- Bootstrap Core JS -->
	<script src="{{ URL::to('tenancy/assets/admin/assets/js/popper.min.js') }}"></script>
	<script src="{{ URL::to('tenancy/assets/admin/assets/js/bootstrap.min.js') }}"></script>
	<!-- Chart JS -->
	<script src="{{ URL::to('tenancy/assets/admin/assets/plugins/morris/morris.min.js') }}"></script>
	<script src="{{ URL::to('tenancy/assets/admin/assets/plugins/raphael/raphael.min.js') }}"></script>
	<script src="{{ URL::to('tenancy/assets/admin/assets/js/chart.js') }}"></script>
	<script src="{{ URL::to('tenancy/assets/admin/assets/js/Chart.min.js') }}"></script>
	<script src="{{ URL::to('tenancy/assets/admin/assets/js/line-chart.js') }}"></script>
	<!-- Slimscroll JS -->
	<script src="{{ URL::to('tenancy/assets/admin/assets/js/jquery.slimscroll.min.js') }}"></script>
	<!-- Select2 JS -->
	<script src="{{ URL::to('tenancy/assets/admin/assets/js/select2.min.js') }}"></script>
	<!-- Datetimepicker JS -->
	<script src="{{ URL::to('tenancy/assets/admin/assets/js/moment.min.js') }}"></script>
	<script src="{{ URL::to('tenancy/assets/admin/assets/js/bootstrap-datetimepicker.min.js') }}"></script>
	<!-- Datatable JS -->
	<script src="{{ URL::to('tenancy/assets/admin/tenancy/assets/admin/assets/js/jquery.dataTables.min.js') }}"></script>
	<script src="{{ URL::to('tenancy/assets/admin/assets/js/dataTables.bootstrap4.min.js') }}"></script>
	<!-- Multiselect JS -->
	<script src="{{ URL::to('tenancy/assets/admin/assets/js/multiselect.min.js') }}"></script>
	<!-- Custom JS -->
	<script src="{{ URL::to('tenancy/assets/admin/assets/js/app.js') }}"></script>
	@yield('script')
</body>
</html>
